...
class RequestPayloadSerializerDict(dict):
    """
    Dict to describe request serializers for allowed actions
    """

    create: Serializer | None
    update: Serializer | None


class ResponsePayloadSerializerDict(dict):
    """
...
class SeparateRequestAndResponseSerializerUpdateModelMixin(UpdateModelMixin):
